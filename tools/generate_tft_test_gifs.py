...
def main() -> None:
    ...
    one.save(args.output / "vega-test-1-frame.gif", save_all=True, loop=0, duration=700)
    two_a.save(args.output / "vega-test-2-frames.gif", save_all=True, append_images=[two_b], loop=0, duration=700)
